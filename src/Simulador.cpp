...
Simulador::Simulador(const int TEMPO_SIMULACAO) : tempoAtual(0), IDAviao(1), pista1(1), pista2(2), pista3(3), pousosDeEmergencia(0),  pousosNormais(0), totalDePousos(0), totalPousosEmergencias(0), numDecolagens(0){}
